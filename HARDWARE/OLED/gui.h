...
//   GND         ��          GND          //OLED����Դ��
//=======================================Һ���������߽���==========================================//
//��ģ��Ĭ��������������ΪIIC   //2023/2/5/17:43�Ѿ��޸�ΪPB3��4
// OLEDģ��               STM32��Ƭ��
//   SDA         ��          PB15         //OLED��IIC�����ź�
//=======================================Һ���������߽���==========================================//
// OLEDģ��               STM32��Ƭ��
...
void GUI_ShowNum(u8 x,u8 y,u32 num,u8 len,u8 Size,u8 mode);                 //常用
void GUI_ShowString(u8 x,u8 y,u8 *chr,u8 Char_Size,u8 mode);                //常用
...
void GUI_ShowCHinese(u8 x,u8 y,u8 hsize,u8 *str,u8 mode);                   //常用
